...
`pip install preview-card`로 다운로드 가능하며 [깃허브]https://github.com/jwkcp/preview-card)에서 소스를 볼 수 있습니다.

> <img src="./img/preview-card-screenshot.png" width="100%" />

---

## [람다그램 lambdagram](https://pypi.org/project/lambdagram/)

**람다그램**은 텔레그램의 공식 API를 이용해 서버없이 AWS lambda에서 챗봇을 쉽게 만들 수 있도록 도와주는 라이브러리입니다.
